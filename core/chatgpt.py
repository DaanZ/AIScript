...
def llm_chat(message_log: History, model_name: str = DEFAULT_LLM_MODEL, temperature: float = 0.0):
...
def llm_strict(history: History, model_name: str = DEFAULT_LLM_MODEL, base_model: type = CalendarEvent):
...
def llm_stream(history, model_name: str = DEFAULT_LLM_MODEL):
